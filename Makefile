...
# FeatureTemplates
# 
# Allows for quick drawing of predefined feature templates speeding up data entry
#                             -------------------
#        begin                : 2013-08-11
...
# translation
SOURCES = featuretemplates.py ui_featuretemplates.py __init__.py featuretemplatesdialog.py
#TRANSLATIONS = i18n/featuretemplates_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = featuretemplates

PY_FILES = featuretemplates.py featuretemplatesdialog.py __init__.py

EXTRAS = icon.png metadata.txt

UI_FILES = ui_featuretemplates.py
